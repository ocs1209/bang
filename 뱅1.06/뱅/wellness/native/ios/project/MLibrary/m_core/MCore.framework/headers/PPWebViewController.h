...
@interface UIWebView (AddEvalFunction)

- (NSString *) evaluatingJavaScriptFromString:(NSString *)script;
...
@interface PPWebViewController : PPViewController<UIWebViewDelegate, MFMailComposeViewControllerDelegate> {
...
- (void) changeHtmlUrl:(NSString *)urlAddress target:(UIWebView*)target;

- (void) setParametersToWebView:(UIWebView*)webView parameters:(NSMutableDictionary*)aParameters;
